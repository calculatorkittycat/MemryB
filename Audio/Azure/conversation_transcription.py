...
###Below line uses our local config file
...
def recognize_from_file():
    # Use SPEECH_KEY and SPEECH_REGION from imported configuration
    ####Below was modified not to use Operating System Environment Variables but use config file###
